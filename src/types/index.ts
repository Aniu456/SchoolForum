...
export interface User {
  ...
  isActive: boolean
  isBanned: boolean
  canPost?: boolean // 是否允许发帖（管理员权限控制）
  canComment?: boolean // 是否允许评论（管理员权限控制）
...
export interface Post {
  ...
  pinnedAt?: string // 置顶时间
  highlightedAt?: string // 加精时间
  createdAt: string
  updatedAt: string
  authorId: string
  author?: {
...
// 通知类型
// ============================================
export type NotificationType = "COMMENT" | "REPLY" | "LIKE" | "SYSTEM" | "NEW_POST" | "NEW_FOLLOWER"
...
// 兼容旧代码的类型别名
// ============================================
export type { Comment as CommentType, Post as PostType, User as UserType }
